...
export async function up(knex: Knex): Promise<void> {
    return knex.schema.createTableIfNotExists("user", (table: Knex.TableBuilder) => {
      ...
      }).createTableIfNotExists('jurusan',(table:Knex.TableBuilder)=>{
        table.string('id',255).notNullable().primary();
        table.string('nama',30).notNullable();
        table.timestamps(true);
      }).createTableIfNotExists('tahun_ajaran',(table:Knex.TableBuilder)=>{
        table.string('id',255).notNullable().primary();
      ...
      }).createTableIfNotExists('mata_pelajaran',(table:Knex.TableBuilder)=>{
        table.string('id',255).notNullable().primary();
        ...
        table.tinyint('jam');
        table.timestamps(true);
      }).createTableIfNotExists('kelas',(table:Knex.TableBuilder)=>{
        table.string('id',255).notNullable().primary();
        ...
        table.timestamps(true);
      }).createTableIfNotExists('mata_pelajaran_ampuan',(table:Knex.TableBuilder)=>{
        table.string('id',255).primary();
        ...
        table.timestamps(true);
      }).createTableIfNotExists('siswa',(table:Knex.TableBuilder)=>{
        table.string('id',255).notNullable().primary();
        table.string('id_user',255).references('id').inTable('user');
        ...
        table.timestamps(true);        
      }).createTableIfNotExists('nilai',(table:Knex.TableBuilder)=>{
        table.string('id',255).primary();
      ...
      .createTableIfNotExists('toko',(table:Knex.TableBuilder)=>{
        table.string('id',255).primary();
        table.string('id_user',255).references('id').inTable('user');
        ...
        table.timestamps(true);
      }).createTableIfNotExists('omzet',(table:Knex.TableBuilder)=>{
        table.string('id',255).primary();
        ...
        table.smallint('status');
        table.timestamps(true);
      }).createTableIfNotExists('dokumen',(table:Knex.TableBuilder)=>{
        table.string('id',255).primary();
        table.string('id_user',255).references('id').inTable('user');
